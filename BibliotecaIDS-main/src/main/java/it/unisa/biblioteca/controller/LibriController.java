...
public class LibriController {
    ...
    private void handleSalva() {
        ...
        try {
            ...
            // CONTROLLO ISBN
            boolean isbnEsistente = biblioteca.getLibriService()
                    .cercaPerIsbn(isbn)
                    .stream()
                    .anyMatch(l -> !modalitaModifica || !l.getIsbn().equals(isbnOriginale));

            if (isbnEsistente) {
                mostraErrore("ISBN già presente nel sistema!");
                return;
            }
            

            if (modalitaModifica && libroSelezionato != null) {
                if (!isbnOriginale.equals(isbn)) {
                    biblioteca.getLibriService().elimina(isbnOriginale);
                }
                ...
                if (isbnOriginale.equals(isbn)) {
                    ...
                    biblioteca.getLibriService().aggiungi(libroSelezionato);
                }
    ...
    private void handleModifica() {
        ...
        isbnOriginale = libroSelezionato.getIsbn();
